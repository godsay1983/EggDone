...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            archive_commands::prepare_archive_batch,
            archive_commands::run_archive_batch,
            archive_commands::pending_archive_batches,
            archive_commands::dismiss_archive_batch,
