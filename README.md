...
未发布改动：主面板支持拖动边缘和四角调整大小；设置中的“外观与窗口”提供小巧、舒适、大窗口预设及 100%–150% 内容缩放。支持 Ctrl/Cmd + 加号、减号、0 调整或恢复内容缩放，尺寸和比例只保存在本机，不参与 S3 同步。详细操作与验收边界见 [窗口可读性说明](docs/WINDOW_READABILITY.md)。
