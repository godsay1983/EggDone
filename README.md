...
模板基础（2026-09-15，未发布）：P2b-1 已实现双端独立模板协议、数据库迁移、增删改事务与重试保护，SQLite 升至 21 / 鸿蒙 RDB 升至 22。目前只有内部存储能力，界面没有新增模板入口；网络同步与备份仍待 P2b-2，详见[实现及边界](docs/TASK_TEMPLATE_STORAGE.md)。
