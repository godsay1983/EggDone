...
模板同步与备份（2026-09-15，未发布）：P2b-2 已接双端独立模板同步、条件写入、待同步状态和备份 v5。旧备份保留本机模板；旧应用不能恢复 v5，请保留升级前备份。模板界面入口待 P2c；应用版本不变，SQLite 21 / RDB 22。见[同步与备份验证](docs/TASK_TEMPLATE_SYNC_BACKUP.md)及[协议与存储](docs/TASK_TEMPLATE_STORAGE.md)。
