...
E6d验证增量（2026-09-12）：E6c已提交（桌面ee67a27、鸿蒙a303b98）；本轮增加磁盘重启回归并复跑系统状态、故障与布局测试，没有业务改动。[验证矩阵及待人工操作](docs/PREFERENCES_REGRESSION_MATRIX.md)。本轮增量未提交，未升版或推送；E6完整验收待确认，E7未开始。下文为历史阶段记录。
